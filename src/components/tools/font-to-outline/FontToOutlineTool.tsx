                        ...
                        {files.map((batchFile) => (
                            <div key={batchFile.id} className="flex items-center justify-between p-3 bg-[color-mix(in_srgb,var(--color-muted)_30%,transparent)] rounded-[var(--radius-md)]">
                                ...
                                {batchFile.status === 'pending' && !isProcessing && (
                                    <button onClick={() => removeFile(batchFile.id)} className="p-1 text-[var(--color-muted-foreground)] hover:text-red-500 transition-colors">
                                        <X className="w-4 h-4" />
                                    </button>
                                )}
                            </div>
            ...
            {hasFiles && (
                <Card variant="outlined">
                    ...
                    <div className="space-y-4">
                        ...
                        ${dpi === d ? 'border-[var(--color-primary)] bg-[var(--color-primary)] text-[var(--color-primary-foreground)]' : 'border-[var(--color-border)] hover:bg-[color-mix(in_srgb,var(--color-muted)_50%,transparent)]'}
