    ...
    <div className={`space-y-6 ${className}`.trim()}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          {baseFile ? (
            <Card variant="outlined" className="relative group p-4 flex items-center justify-between border-2 border-[color-mix(in_srgb,var(--color-primary)_30%,transparent)] bg-[color-mix(in_srgb,var(--color-muted)_15%,transparent)] rounded-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm text-[var(--color-foreground)] truncate max-w-[200px]" title={baseFile.name}>
                    {baseFile.name}
                  </p>
          ...
          {layerFile ? (
            <Card variant="outlined" className="relative group p-4 flex items-center justify-between border-2 border-emerald-500/35 bg-emerald-500/5 rounded-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm text-[var(--color-foreground)] truncate max-w-[200px]" title={layerFile.name}>
                    {layerFile.name}
                  </p>
                  <p className="text-xs text-[var(--color-muted-foreground)]">
      ...
      {baseFile && layerFile && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            <Card variant="outlined" className="p-6 bg-[var(--color-card)] rounded-2xl flex flex-col items-center justify-center min-h-[300px] overflow-hidden">
              <span className="text-xs font-bold text-[var(--color-muted-foreground)] mb-8">
              ...
              >
                ...
                <div 
                  className="absolute inset-0 bg-white dark:bg-zinc-900 border-2 border-[var(--color-primary)] shadow-xl rounded-xl flex items-center justify-center font-black text-[var(--color-primary)] select-none transition-all duration-700 ease-in-out"
                  style={{
          ...
          <div className="lg:col-span-7 space-y-6">
            <Card variant="default" className="p-6 rounded-2xl space-y-6 backdrop-blur-md bg-white/40 dark:bg-black/30 border border-white/20 dark:border-zinc-800/40">
              <h3 className="text-md font-bold text-[var(--color-foreground)] border-b border-[var(--color-border)] pb-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex bg-[color-mix(in_srgb,var(--color-muted)_50%,transparent)] p-1 rounded-xl">
                  <button
                    onClick={() => setMode('overlay')}
                    className={`flex-1 py-2.5 text-xs font-bold rounded-lg transition-all ${
                      mode === 'overlay'
                        ? 'bg-[var(--color-card)] text-[var(--color-foreground)] shadow'
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-sm rounded-xl bg-[color-mix(in_srgb,var(--color-muted)_30%,transparent)] border border-[var(--color-input)] text-[var(--color-foreground)] placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] transition-all"
                />
              </div>
              ...
              <div className="flex items-center justify-between pt-2 border-t border-[var(--color-border)]">
                <div>
                  ...
                  <span className="text-[10px] text-[var(--color-muted-foreground)] mt-0.5 block leading-normal max-w-md">
            ...
            <div className="space-y-3">
              <Button
                ...
                disabled={isProcessing}
                className="w-full py-4 font-bold shadow-lg shadow-[color-mix(in_srgb,var(--color-primary)_15%,transparent)]"
              >
